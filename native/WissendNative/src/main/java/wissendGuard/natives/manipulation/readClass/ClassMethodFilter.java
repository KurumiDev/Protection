package wissendGuard.natives.manipulation.readClass;

import wissend.api.annotation.MainClass;
...
public class ClassMethodFilter {
    ...
    private static final String NOT_NATIVE_ANNOTATION_DESC = Type.getDescriptor(MainClass.class);
