...
import wissendGuard.natives.manipulation.LabelPool;
import wissendGuard.natives.manipulation.Snippets;
import wissendGuard.natives.manipulation.source.StringPool;
import wissendGuard.natives.manipulation.readClass.CachedFieldInfo;
import wissendGuard.natives.manipulation.readClass.CachedMethodInfo;
...
public class MethodContext {
    ...
    public Transpilator obfuscator;
    ...
    public MethodContext(Transpilator obfuscator, MethodNode method, int methodIndex, ClassNode clazz,
                         int classIndex) {
