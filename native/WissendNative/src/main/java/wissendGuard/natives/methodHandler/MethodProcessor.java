package wissendGuard.natives.methodHandler;

import wissendGuard.natives.Transpilator;
import wissendGuard.natives.manipulation.Util;
import wissendGuard.natives.manipulation.instructions.*;
import wissendGuard.natives.manipulation.special.ClInitSpecialMethodProcessor;
import wissendGuard.natives.manipulation.special.DefaultSpecialMethodProcessor;
import wissendGuard.natives.manipulation.special.SpecialMethodProcessor;
import wissendGuard.natives.manipulation.readClass.CatchesBlock;
...
public class MethodProcessor {
    ...
    private final Transpilator obfuscator;
    private final InstructionHandlerContainer<?>[] handlers;

    public MethodProcessor(Transpilator obfuscator) {
        ...
        addHandler(AbstractInsnNode.FIELD_INSN, new HandlerFields(), FieldInsnNode.class);
        ...
        addHandler(AbstractInsnNode.FRAME, new HandlerFrame(), FrameNode.class);
