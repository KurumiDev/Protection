...
public class TestRemapper3 {
    public static void main(String[] args) throws Exception {
        ...
        String result = asmRemapper.mapMethodName("code/cataclysm/features/module/setting/implement/BooleanSetting", "setVisible", "(Ljava/util/function/Supplier;)V");
        System.out.println("BooleanSetting.setVisible -> " + result);
        
        result = asmRemapper.mapMethodName("code/cataclysm/features/module/setting/Setting", "setVisible", "(Ljava/util/function/Supplier;)V");
        System.out.println("Setting.setVisible -> " + result);
    }
}
